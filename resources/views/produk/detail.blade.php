            ...
            <div class="col-lg-4 col-md-5 col-sm-12">
              <div class="owl-carousel owl-theme">
                <div class="item" data-hash="zero">
                  <img src="{{ asset('upload/image/'.$produk->gambar) }}" alt="<?php echo $produk->nama_produk; ?>" class="img img-thumbnail img-fluid">
                </div>
                <?php if($gambar) { foreach($gambar as $gambar) { ?>
                <div class="item" data-hash="one<?php echo $gambar->id_gambar_produk ?>">
                  <img src="{{ asset('/upload/image/'.$gambar->gambar) }}" alt="<?php echo $produk->nama_produk; ?>" class="img img-thumbnail img-fluid">
                </div>
                <?php }} ?>
              </div>
                <div class="row">
                  <a class="button secondary url col-lg-3 col-md-3 col-sm-3 col-xs-3 url" href="#zero">
                    <img src="{{ asset('upload/image/thumbs/'.$produk->gambar) }}" alt="<?php echo $produk->nama_produk; ?>" class="img img-thumbnail img-fluid" >
                  </a>
                  ...
                  <a class="button secondary col-lg-3 col-md-3 col-sm-3 col-xs-3 url" href="#one<?php echo $gambar->id_gambar_produk ?>">
                    <img src="{{ asset('/upload/image/thumbs/'.$gambar->gambar) }}" alt="<?php echo $produk->nama_produk; ?>" class="img img-thumbnail img-fluid" >
                  </a>
                  <?php }} ?>
                </div>
