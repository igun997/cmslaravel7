...
<form action="{{ asset('admin_assets/konfigurasi/proses_gambar') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
<div class="row">
    ...
    <div class="col-md-6 alert alert-success">
        ...
        <img src="{{ asset('upload/image/'.$site->gambar) }}" style="max-width:200px; height:auto;">
    </div>
