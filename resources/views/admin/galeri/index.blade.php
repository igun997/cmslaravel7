...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="{{ asset('admin_assets/galeri/cari') }}" method="get" accept-charset="utf-8">
    <br>
    <div class="input-group">
      ...
      <span class="input-group-btn btn-flat">
        ...
        <a href="{{ asset('admin_assets/galeri/tambah') }}" class="btn btn-success">
...
<form action="{{ asset('admin_assets/galeri/proses') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
<div class="row">
  <div class="col-md-4">
    <div class="input-group">
        ...
        <tbody>
          ...
          <?php $i=1; foreach($galeri as $galeri) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><img src="{{ asset('upload/image/thumbs/'.$galeri->gambar) }}" class="img img-thumbnail img-fluid"></td>
              <td><?php echo $galeri->judul_galeri ?></td>
              <td><a href="{{ asset('admin_assets/galeri/kategori/'.$galeri->id_kategori_galeri) }}"><?php echo $galeri->nama_kategori_galeri ?></a></td>
              <td><a href="{{ asset('admin_assets/galeri/status_galeri/'.$galeri->jenis_galeri) }}">
                  <?php echo $galeri->jenis_galeri ?></a></td>
              <td>
                    <div class="btn-group">

                        <a href="{{ asset('admin_assets/galeri/edit/'.$galeri->id_galeri) }}"
                          class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                          <a href="{{ asset('admin_assets/galeri/delete/'.$galeri->id_galeri) }}" class="btn btn-danger btn-sm delete-link"><i class="fa fa-trash"></i></a>
                        </div>
