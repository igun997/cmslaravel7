        ...
        <tbody>
          ...
          <?php $i=1; foreach($produk as $produk) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><img src="{{ asset('upload/image/thumbs/'.$produk->gambar) }}" class="img img-responsive img-thumbnail" width="60"></td>
                ...
                <td><?php echo $produk->stok ?> <?php echo $produk->satuan ?></td>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a href="{{ asset('admin_assets/gambar_produk/produk/'.$produk->id_produk) }}"
