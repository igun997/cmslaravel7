...
<tr>
    ...
    <i class="fa fa-edit"></i> Edit
      ...
      <a href="{{ asset('admin_assets/kategori_download/delete/'.$kategori_download->id_kategori_download) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i> Hapus</a>
      </div>
